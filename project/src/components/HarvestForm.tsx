...
const SECTOR_TUNNELS = {
  '1A': 16, '1B': 19, '1C': 20, '1D': 19, '1E': 16,
  '2A': 20, '2B': 20, '2C': 20, '2D': 22, '2E': 26,
  '3A': 25, '3B': 20, '3C': 20,
  '4A': 23, '4B': 20, '4C': 20,
  '5A': 22, '5B': 20, '5C': 20,
  '6A': 29, '6B': 14, '6C': 37, '6D': 37,
  '7A': 14, '7B': 29, '7C': 35, '7D': 25, '7E': 19
};
...
export default function HarvestForm() {
  ...
  const getTunnelOptions = (sector: string) => {
    const tunnelCount = SECTOR_TUNNELS[sector as keyof typeof SECTOR_TUNNELS] || 0;
    return Array.from({ length: tunnelCount }, (_, i) => (i + 1).toString());
  };
