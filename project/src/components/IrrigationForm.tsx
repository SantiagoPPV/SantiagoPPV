...
const SECTOR_TUNNELS = {
  ...
  '3A': [1, 25], '3B': [1, 20], '3C': [1, 20], '4AV1': [1, 14], '4AV2': [15, 23], 
  '4B': [1, 20], '4C': [1, 20], '5A': [1, 22], '5B': [1, 20], '5C': [1, 20],
  '6AV1': [1, 15],'6AV2': [16, 29], '6B': [15, 28], '6CV1': [19, 38],'6CV2': [20, 38], 
  '6DV1': [1, 19],'6DV2': [20, 37], '7A': [1, 14], '7BV1': [1, 15],'7BV2': [16, 29], 
  '7CV1': [1, 18], '7CV2': [19, 35],'7D': [1, 25], '7E': [1, 19]
};
